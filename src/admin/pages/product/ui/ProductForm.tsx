...
export const ProductForm = ({ title, subtitle, product, onSubmit }: Props) => {
  ...
  const addTag = () => {
    ...
    const newTag = inputTag.current?.value;

    if (!newTag) return;

    if (newTag && !getValues('tags').includes(newTag.trim())) {
      tagsSet.add(newTag);
              ...
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    {errors.price && (
                      <p className='text-red-500 text-xs'>
                        El precio es requerido y mayor que 0
                      </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.stock && (
                      <p className='text-red-500 text-xs'>
                        El stock es requerido y mayor que 0
                      </p>
                    )}
                  </div>
                </div>
